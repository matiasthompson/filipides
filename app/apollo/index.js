...
exports.initApollo = (app, httpServer) => {
  ...
  logger.info(`ð Apollo Normal server ready at http://${process.env.DOMAIN_BACK}${process.env.APOLLO_PATH}`);
  logger.info(`ð Apollo PubSub server ready at ws://${process.env.DOMAIN_BACK}${apolloServer.subscriptionsPath}`);
};
